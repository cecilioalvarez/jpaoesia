...
INSERT INTO `Socios` (`dni`, `nombre`, `apellidos`,`calle`,`numero`) VALUES ('123','pedro','gomez','micalle',1 );
INSERT INTO `Socios` (`dni`, `nombre`, `apellidos`,`calle`,`numero`) VALUES ('321','ana','gomez','micalle',2 );
