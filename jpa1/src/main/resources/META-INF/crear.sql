...
CREATE TABLE `Socios` (`dni` VARCHAR(10) ,`nombre` VARCHAR(25) , apellidos VARCHAR(25) ,PRIMARY KEY (`dni`));
CREATE TABLE `Tarjetas` (`dni` VARCHAR(10) ,`numero` INT , fecha DATE ,PRIMARY KEY (`dni`));
